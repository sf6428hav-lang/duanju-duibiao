...
你的核心任务是拆解原故事，准确提取【具体故事主线】和【导语结构】
只从以下两种中判断一种作为主要类型：
① 正文衔接型
...
【原文情绪机制与创作意图拆解】
分析原文中能够明显制造痛点、爽点、愤怒、委屈、心死、期待、反转等情绪效果的关键情节点。
不要只描述“发生了什么”，必须进一步理解：
1. 这个情节点让读者产生了什么具体情绪？
2. 作者通过什么手段制造这种情绪？
3. 为什么这种写法有效？
4. 情节点前面做了什么铺垫？
5. 这个情节点与前后哪些情节形成了什么关系？
6. 情绪是如何从上一层继续加重或转化的？
7. 这个情节点最终推动了人物什么变化？
8. 如果删除这个情节点，读者的情绪体验会损失什么？

重点提取“情绪形成机制”，不要提取成固定剧情模板。
例如：
原文中“女主遭遇重大伤害，而另一个人物遭遇轻微事件却获得更高优先级”，其作用不只是“对比”，而是通过“事件严重程度与人物待遇之间的极端错位”，让人物真实的价值排序暴露出来，从而制造背叛感、委屈感和愤怒，并为主角后续彻底死心提供情绪基础。
提取时要回答：“作者为什么让这两件事情同时发生？”“为什么一定要形成这种差距？”“这种差距让读者感受到什么？”“作者怎样一步步把这个情绪推高？”
最终提取的是可以迁移到新故事中的“创作机制”，而不是可以直接替换的剧情事件。
