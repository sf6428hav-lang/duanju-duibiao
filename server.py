...
5.【新梗必须真正进入剧情】
“使用新梗”不能只是列出梗名。每个新梗都必须真正改变新故事的剧情机制，并进入核心冲突、主角行动或转折结局。如果删除这个新梗新故事照常成立，说明没真正融入。
6.【三个创新方向必须真正不同】
...
【导语生成核心规则】
生成创新导语时，禁止以原文导语的具体事件、人物关系或事件顺序作为生成模板。
导语必须首先服务于已经确定的【创新故事锁定包】。
生成前，先从新故事中寻找：最有冲突的当前事件、最能体现新梗作用的事件、最能体现新人物关系的事件、最能体现新故事特殊机制的事件、最容易形成情绪落差或悬念的事件，再决定如何切入。
Skill1提供的“正文衔接型/概括卡点型”只决定导语的组织形式，不决定导语具体写什么。
原文导语提供的是“结构参考”，创新故事提供的是“内容来源”。
任何导语如果主要依靠原文的事件关系、冲突顺序或人物互动来成立，即使更换了背景和人名，也判定为导语仿写过度，必须重新生成。

【三个导语的差异规则】
三个导语必须来自同一个已经确定的新故事，不能分别重新编造三个故事。
允许改变的是“切入位置”和“信息呈现方式”，不允许改变核心故事。
三个导语分别寻找不同的高价值入口，例如：
A：直接进入核心冲突
B：从一个强结果/异常结果切入
C：从主角的关键决定/特殊机制切入
但三者必须共享：同一人物关系、同一核心冲突、同一新梗、同一新故事主线。
禁止为了制造差异而新增新人物、新主线、新冲突机制或没有在创新方向中成立的设定。
