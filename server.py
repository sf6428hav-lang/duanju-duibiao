...
如果删除这个新梗后，新故事主体仍然可以基本照常成立，则本步骤失败。

【失败处理】
不得进入Step 5。
必须重新调整新梗与剧情的关系，直到新梗真正改变故事。

━━━━━━━━━━━━━━━━━━
【Step 5｜在原文有效基础上重新形成新故事】
━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━
【Step 6｜创新独立性与迭代有效性检查】
━━━━━━━━━━━━━━━━━━

内部检查以下问题：

1. 新故事是不是只换了背景、职业、人物和道具？
2. 原文具体事件顺序是不是仍然基本存在？
3. 原文人物关系是不是换个名字继续承担同样冲突？
4. 原文痛点是不是只换了一个表面事件？
5. 新梗是否真正改变了剧情？
6. 删除新梗以后，故事是不是还能基本照常成立？
7. 新故事有没有自己的冲突发动方式？
8. 新故事有没有自己的高潮和结局逻辑？
9. 新故事是否仍保持原文对标基调？
10. 新故事是不是因为新梗而发生了真实变化？
...
导语必须按照原文已经验证有效的基础组织能力来组织，但具体内容必须来自新故事。

同时必须让新梗进入导语对应的剧情。

例如：
新梗是避嫌，不得只让人物说一句“避嫌”，必须让避嫌已经对当前事件产生真实后果；
新梗是死遁，必须让死遁已经影响主角当前身份、处境或行动；
新梗是倒计时，必须让期限进入当前冲突；
新梗是马甲，必须让身份差异参与当前冲突或信息差。
...
禁止写成：
“人物介绍→发生A→发生B→发生C”的剧情简介或流水账。

三个导语属于同一个已经确定的新故事。
不要求刻意改变切入口。
不要求为了制造差异而新增剧情。
可以围绕同一个核心入口，从不同的信息浓度、表达方式或情绪力度进行呈现。
...
1. 开局是否已经进入新故事真正的核心矛盾？
2. 有没有明显的流水账？
3. 冲突有没有从前一句继续升级？
4. 情绪有没有不断加重或发生变化？
5. 是否存在对比、反差、补刀或其他有效情绪机制？
6. 新梗是否在导语中产生实际剧情作用？
7. 是否只是把原文换成新人物、新背景、新道具？
8. 是否仍符合Skill1确定的原文基调？
9. 结尾是否形成明确卡点？
10. 导语之后正文是否能够自然承接？
