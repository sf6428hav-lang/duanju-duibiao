...
2.【禁止剧情结构同构】
禁止出现“换背景不换结构”“换人物不换因果”。如果把新故事的人名、背景、道具重新换回原文后，仍然可以将主要剧情节点一一对应，则必须推翻重新设计。判断标准不是“有没有换要素”，而是骨架是否雷同。
3.【禁止逐节点翻译原文】
...
【导语功能映射，不得逐句仿写】
生成新故事导语规划前，必须读取Skill1提供的【导语结构】、【逐句拆解】和【导语功能骨架】。
Skill1提供的导语分析只用于理解原文的“组织方式、信息释放顺序、情绪递进方式和句子功能”，不得直接作为新导语的剧情模板。
执行时必须完成：原文句子功能 → 新故事中的对应功能 → 用新梗和新剧情重新实现。
例如，原文某一句的功能是“通过人物行为暴露真实价值排序”，新故事必须重新寻找一种属于自身人物关系和剧情机制的事件来完成这个功能，而不是寻找一个与原文相似的“偏爱/袒护”事件进行替换。
必须保持：导语整体的功能推进关系、情绪递进方向、信息释放节奏、最终卡点的力度。
必须重新设计：具体事件、人物行为、冲突发生方式、痛点实现方式、信息载体、主角反应、最终卡点内容。
禁止采用“原文第1句→新故事对应第1句”的逐句翻译模式。真正目标：保留“原作者为什么这样写、这一句承担什么作用”，改变“新故事里具体发生了什么”。
生成前必须先完成内部判断：“原文每个功能，在我的新故事里分别可以由什么全新的事件承载？”然后才能规划导语切入点。
...
【导语功能映射，不得逐句仿写】
生成新故事导语前，必须读取Skill1提供的【导语结构】、【逐句拆解】和【导语功能骨架】。
Skill1提供的导语分析只用于理解原文的“组织方式、信息释放顺序、情绪递进方式和句子功能”，不得直接作为新导语的剧情模板。
执行时必须完成：原文句子功能 → 新故事中的对应功能 → 用新梗和新剧情重新实现。
例如，原文某一句的功能是“通过人物行为暴露真实价值排序”，新故事必须重新寻找一种属于自身人物关系和剧情机制的事件来完成这个功能，而不是寻找一个与原文相似的“偏爱/袒护”事件进行替换。
必须保持：导语整体的功能推进关系、情绪递进方向、信息释放节奏、最终卡点的力度。
必须重新设计：具体事件、人物行为、冲突发生方式、痛点实现方式、信息载体、主角反应、最终卡点内容。
禁止采用“原文第1句→新故事对应第1句”的逐句翻译模式。真正目标：保留“原作者为什么这样写、这一句承担什么作用”，改变“新故事里具体发生了什么”。
生成前必须先完成内部判断：“原文每个功能，在我的新故事里分别可以由什么全新的事件承载？”然后才能开始写导语。
