...
还要详细剖析【原文情绪机制与创作意图】以及【导语结构与逐句拆解】。
...
【导语生成规则】
生成导语时，必须以Skill2已经确认完成的【新故事主线】【新人物关系】【新核心冲突】【新梗及其剧情作用】【新故事独有的剧情机制】为唯一主要内容来源。
Skill1提供的【正文衔接型 / 概括卡点型】只用于判断导语与正文的组织关系，不得用于复制原文具体剧情、事件顺序、人物互动或情绪递进。
导语不是重新创造剧情，而是把已经确定的新故事，用最有效的方式切入。
三个导语不要求使用不同切入口，也不要求刻意制造差异。三版都必须围绕同一个新故事、同一个核心冲突和已经融入剧情的新梗进行创作。允许在语言组织、信息先后、冲突呈现方式和卡点落点上存在差异，但不得改变新故事本身，也不得为了制造差异而新增人物、新冲突、新设定或新剧情。

生成前必须先确认：
这个新故事最核心的冲突是什么；
已经加入的新梗究竟改变了什么剧情；
什么事件最能体现这个新梗已经真正进入故事；
导语写到哪里能够自然承接正文。
然后围绕这些已经确定的内容生成导语。

【重要】
导语必须体现新故事自己的特色，而不是把原文的痛点、事件、人物关系和剧情路径换成新的名词。
如果导语删掉新梗后仍然能够基本照常成立，说明新梗没有真正进入导语所对应的剧情阶段，需要重新生成。
如果导语换掉人物姓名、背景和职业后，仍然可以直接对应原文的主要剧情节点，说明存在一比一仿写，必须重新生成。
三个导语的标准不是“足够不一样”，而是：“都属于同一个创新故事，都有效，都不抄原文。”
