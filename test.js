    ...
    function closeEditor() {
      E('editorPane').style.display = 'none';
      currentPreviewFile = "";
    }
    ...
    async function pv(path) {
      try {
        E('editorPane').style.display = 'flex';
